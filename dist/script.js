...
/* функционал добавления модального окна программным путём */
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.remAttr = function (name) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggAttr = function (name, value) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.show = function () {
  for (let i = 0; i < this.length; i++) {
    if (!this[i].style) {
      continue;
      /* если у объекта нет свойства style - пропускаем */
    }
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  ...
  btns: {
    count: 3,
    settings: [['Close', ['btn-danger', 'mr-10'], true], ['Зберегти зміни', ['btn-success'], false, () => {
      alert('Данні збережені');
    }], ['Нова кнопка', ['btn-warning', 'ml-10'], false, () => {
      alert('Привіт, Світ!');
    }]]
  }
}));
